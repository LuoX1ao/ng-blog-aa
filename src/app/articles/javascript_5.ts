...
<h2 class="article-title">The Factory Pattern</h2>
<p>
...
<p>
Imagine that we have a UI factory where we are asked to create a type of UI component. Rather than creating this component directly using the <code class="code">new</code> operator or via another creational constructor, we ask a Factory object for a new component instead. We inform the Factory what type of object is required (e.g "Button", "Panel") and it instantiates this, returning it to us for use.
</p>
...
<p><b>Approach #1: Modify a VehicleFactory instance to use the Truck class</b></p>
<pre><code mwlHighlightJs [source]="source[1]" language="javascript"></code></pre>

<p><b>Approach #2: Subclass VehicleFactory to create a factory class that builds Trucks</b></p>
...
<p>It is also useful to be aware of the Abstract Factory pattern, which aims to encapsulate a group of individual factories with a common goal. It separates the details of implementation of a set of objects from their general usage.
</p>
<p>
